...
import './Sp3.css'; // File CSS đi kèm

function Sp3() {
  const [quantity, setQuantity] = useState(1);
  const [mainImage, setMainImage] = useState('/sp/sp 3.jpg'); // Đặt ảnh mặc định

  const products = [
    { id: 7, title: "De Coco Lalin", price: "90.000 đ", img: '/sp/sp 7.jpg', link: '/product/7' },
    { id: 6, title: "De Coco Narin", price: "90.000 đ", img: '/sp/sp 6.jpg', link: '/product/3' },
    { id: 4, title: "De Coco Mori", price: "100.000 đ", img: '/sp/sp 4.jpg', link: '/product/4' },
        ...
        <section className="page">
            ...
            <div className="product-image">
                ...
                <img
                    src="/sp/sp 3.jpg"
                    alt="Thumbnail 1"
                    onClick={() => handleThumbnailClick('/sp/sp 3.jpg')}
                    className="thumbnail"
                />
                <img
                    src="/sp/sp 3(1).jpg"
                    alt="Thumbnail 2"
                    onClick={() => handleThumbnailClick('/sp/sp 3(1).jpg')}
                    className="thumbnail"
                />
                <img
                    src="/sp/sp 2(2).jpg"
