...
import './Sp5.css'; // File CSS đi kèm

function Sp5() {
  const [quantity, setQuantity] = useState(1);
  const [mainImage, setMainImage] = useState('/sp/sp 5.jpg'); // Đặt ảnh mặc định
        ...
        <section className="page">
            ...
            <div className="product-image">
                ...
                <img
                    src="/sp/sp 5.jpg"
                    alt="Thumbnail 1"
                    onClick={() => handleThumbnailClick('/sp/sp 5.jpg')}
                    className="thumbnail"
                />
                <img
                    src="/sp/sp 5(1).jpg"
                    alt="Thumbnail 2"
                    onClick={() => handleThumbnailClick('/sp/sp 5(1).jpg')}
                    className="thumbnail"
                />
                <img
                    src="/sp/sp 2(2).jpg"
            ...
            <div className="product-details">
                <h1>De Coco Starfish</h1>
                <p className="price">70.000 đ</p>
