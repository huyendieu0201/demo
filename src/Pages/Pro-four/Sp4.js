...
import './Sp4.css'; // File CSS đi kèm

function Sp4() {
  const [quantity, setQuantity] = useState(1);
  const [mainImage, setMainImage] = useState('/sp/sp 4.jpg'); // Đặt ảnh mặc định
  ...
  const products = [
    ...
    { id: 8, title: "DECOCO ACC J'adore", price: "60.000 đ", img: '/sp/sp 8.jpg',link: '/product/8'},
        ...
        <section className="page">
            ...
            <div className="product-image">
                ...
                <img
                    src="/sp/sp 4.jpg"
                    alt="Thumbnail 1"
                    onClick={() => handleThumbnailClick('/sp/sp 4.jpg')}
                    className="thumbnail"
                />
                <img
                    src="/sp/sp 4(1).jpg"
                    alt="Thumbnail 2"
                    onClick={() => handleThumbnailClick('/sp/sp 4(1).jpg')}
                    className="thumbnail"
                />
                <img
                    src="/sp/sp 2(2).jpg"
