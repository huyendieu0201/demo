...
import './Sp8.css'; // File CSS đi kèm
import "slick-carousel/slick/slick.css";
import "slick-carousel/slick/slick-theme.css";

function Sp8() {
  const [quantity, setQuantity] = useState(1);
  const [mainImage, setMainImage] = useState('/sp/sp 8.jpg');
  ...
  const products = [
    ...
    { id: 7, title: "De Coco Mori", price: "80.000 đ", img: '/sp/sp 4.jpg', link: '/product/4' },
  ];
      ...
      <section className="page">
        <div className="product-page">
          <div className="product-image">
            ...
            <div className="product-thumbnails">
              <img
                src="/sp/sp 8.jpg"
                alt="Thumbnail 1"
                onClick={() => handleThumbnailClick('/sp/sp 8.jpg')}
                className="thumbnail"
              />
              <img
                src="/sp/sp 8(1).jpg"
                alt="Thumbnail 2"
                onClick={() => handleThumbnailClick('/sp/sp 8(1).jpg')}
                className="thumbnail"
              />
              <img
                src="/sp/sp 2(2).jpg"
          ...
          <div className="product-details">
            <h1>De Coco J'adore</h1>
            <p className="price">60.000đ</p>

            <div className="color-select-sp8">
              <label>Color: Gold</label>
              <div className="color-circle-sp8"></div>
            </div>
