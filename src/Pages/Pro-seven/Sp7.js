...
import './Sp7.css'; // File CSS đi kèm

function Sp7() {
  const [quantity, setQuantity] = useState(1);
  const [mainImage, setMainImage] = useState('/sp/sp 7.jpg'); // Đặt ảnh mặc định
        ...
        <section className="page">
            ...
            <div className="product-image">
                ...
                <img
                    src="/sp/sp 7.jpg"
                    alt="Thumbnail 1"
                    onClick={() => handleThumbnailClick('/sp/sp 7.jpg')}
                    className="thumbnail"
                />
                <img
                    src="/sp/sp 7(1).jpg"
                    alt="Thumbnail 2"
                    onClick={() => handleThumbnailClick('/sp/sp 7(1).jpg')}
                    className="thumbnail"
                />
                <img
                    src="/sp/sp 2(2).jpg"
